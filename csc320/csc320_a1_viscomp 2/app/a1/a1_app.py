...
class Assignment1App(base_app.BaseAssignmentApp):
    ...
    def init_state(self):
        ...
        if input_ratio < screen_ratio:
            ...
            self.buffer[offset:offset+self.input_image.shape[0], 0:(w//2)] = self.input_image 
        else:
            ...
            self.buffer[0:h, offset:offset+self.input_image.shape[1]] = self.input_image 
    ...
    def render(self):
        ...
        if self.dirty_canvas:
            if self.left_corner_index == 4 and self.right_corner_index == 4:
                output = viscomp.algos.run_a1_algo(self.buffer, self.buffer, self.left_corners, self.right_corners)
    ...
    def on_mouse_press(self, x, y, button):
        ...
        if self.left_corner_index == 4 and self.right_corner_index == 4:
            self.H_matrix = viscomp.algos.calculate_homography(self.right_corners, self.left_corners)
