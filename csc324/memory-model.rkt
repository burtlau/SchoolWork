...
(module model racket
  ...
  (provide wait! wait-declaration! interleave! scale! body-width! stack!)
  (provide show)
  ...
  (module Drawing slideshow
    ...
    (define (layout-siblings siblings)
      (apply ht-append (scale) siblings))
    (define (layout-parent-children parent children)
      (if (empty? children)
          parent
          (vc-append (* 2 (scale)) parent (layout-siblings children))))
