...
(check-equal? (eve '(((λ (y) (λ (x) y)) 324) 325))
              '(324
                #hash((E1 . ((y 324) E0))
                      (E2 . ((x 325) E1))
                      (λ0 . ((λ (y) (λ (x) y)) E0))
...
(check-equal? (eve '((λ (x) ((λ (y) x) 324)) 325))
              '(325
                #hash((E1 . ((x 325) E0))
                      (E2 . ((y 324) E1))
                      (λ0 . ((λ (x) ((λ (y) x) 324)) E0))
...
(check-equal? (eve '((λ (y) (λ (z) (λ (w) q))) 324))
              '(λ1
                #hash((E1 . ((y 324) E0))
                      (λ0 . ((λ (y) (λ (z) (λ (w) q))) E0))
                      (λ1 . ((λ (z) (λ (w) q)) E1)))))

; A function body takes in replaceble elemnts as pattern
(check-equal? (eve '((λ (x) (x x)) (λ (y) 324)))
              '(324
                #hash((E1 . ((x λ1) E0))
                      (E2 . ((y λ1) E0))
                      (λ0 . ((λ (x) (x x)) E0))
...
(define environments-closures #hash((E1 . ((y 324) E0))
                                    (E2 . ((y 325) E1))))
...
(check-equal? (get-var 'y (get-env 'E1)) 324)
(check-equal? (get-var 'y (get-env 'E2)) 325)
